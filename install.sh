...
mkdir -p "Live-Tools-V2-main 2025/log"

echo "Installation des packages nécessaires..."
cd "Live-Tools-V2-main 2025"
...
(crontab -l 2>/dev/null; echo "*/5 * * * * cd \"$(pwd)\" && /bin/bash ./BtcX1.sh >> ./log/BtcX1.log 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "0-59/5 * * * * cd \"$(pwd)\" && sleep 30 && /bin/bash ./BtcX2.sh >> ./log/BtcX2.log 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "1-59/5 * * * * cd \"$(pwd)\" && /bin/bash ./BtcX5.sh >> ./log/BtcX5.log 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "1-59/5 * * * * cd \"$(pwd)\" && sleep 30 && /bin/bash ./BtcX10.sh >> ./log/BtcX10.log 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "2-59/5 * * * * cd \"$(pwd)\" && /bin/bash ./BtcX20.sh >> ./log/BtcX20.log 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "2-59/5 * * * * cd \"$(pwd)\" && sleep 30 && /bin/bash ./BtcX30.sh >> ./log/BtcX30.log 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "3-59/5 * * * * cd \"$(pwd)\" && /bin/bash ./AltX3High.sh >> ./log/AltX3High.log 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "3-59/5 * * * * cd \"$(pwd)\" && sleep 30 && /bin/bash ./AltX3Traling.sh >> ./log/AltX3Traling.log 2>&1") | crontab -
