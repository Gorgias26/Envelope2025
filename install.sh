...
(crontab -l 2>/dev/null; echo "*/5 * * * * cd \"$(pwd)/Envelope2025\" && /bin/bash ./BtcX1.sh >> \"$(pwd)/log/BtcX1.log\" 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "0-59/5 * * * * cd \"$(pwd)/Envelope2025\" && sleep 30 && /bin/bash ./BtcX2.sh >> \"$(pwd)/log/BtcX2.log\" 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "1-59/5 * * * * cd \"$(pwd)/Envelope2025\" && /bin/bash ./BtcX5.sh >> \"$(pwd)/log/BtcX5.log\" 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "1-59/5 * * * * cd \"$(pwd)/Envelope2025\" && sleep 30 && /bin/bash ./BtcX10.sh >> \"$(pwd)/log/BtcX10.log\" 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "2-59/5 * * * * cd \"$(pwd)/Envelope2025\" && /bin/bash ./BtcX20.sh >> \"$(pwd)/log/BtcX20.log\" 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "2-59/5 * * * * cd \"$(pwd)/Envelope2025\" && sleep 30 && /bin/bash ./BtcX30.sh >> \"$(pwd)/log/BtcX30.log\" 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "3-59/5 * * * * cd \"$(pwd)/Envelope2025\" && /bin/bash ./AltX3High.sh >> \"$(pwd)/log/AltX3High.log\" 2>&1") | crontab -
(crontab -l 2>/dev/null; echo "3-59/5 * * * * cd \"$(pwd)/Envelope2025\" && sleep 30 && /bin/bash ./AltX3Traling.sh >> \"$(pwd)/log/AltX3Traling.log\" 2>&1") | crontab -
